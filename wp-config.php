...
define('DB_NAME', 'influxiq_probid');

/** MySQL database username */
define('DB_USER', 'influxiq_probid');

/** MySQL database password */
define('DB_PASSWORD', 'P@ss7890');

/** MySQL hostname */
define('DB_HOST', 'influxiq.com');
...
//define('WP_SITEURL','http://probid.influxiq.com/');
